...
struct MHManagement: View {
    ...
    private let management: [String: String] = [
        ...
        "lowRisk": "The patient is classified as low risk for malignancy.  Engage in shared decision-making with the patient.  Options are to repeat a urinalysis within 6 months OR perform a cystoscopy and renal ultrasound now.  Refer to urology if cystoscopy is to be performed.",
